...
int runUserCommands(struct userCommands *cmdStruct, int *lastProcStat, struct bg_node *procList); // runs the commands entered by the user
void executeOthers(struct userCommands *cmdStruct, int *lastProcStat, struct bg_node *procList); // this function executes all non custom bash commands given
